...
<tr><th><b>Feedback Id</b></th><th><b>Er.No.</b></th><th><b>Rating</b></th><th><b>Comment</b></th></tr>
<%
PreparedStatement ps=con.prepareStatement("select * from feedback");
ResultSet r=ps.executeQuery();
if(r.next()){
do{
	String fd=r.getString(3);
	String er=r.getString(4);
	String c=r.getString(2);
	String ra=r.getString(1);
	%>
	<tr><td><%=fd%></td><td><%=er %></td><td><%=ra %></td><td><%=c %></td></tr>
<%
}while(r.next());
}
%>
