...
<tr><th><b>Complaint Id</b></th><th><b>Er.No.</b></th><th><b>Name</b></th><th><b>Register date</b></th><th><b>Problem</b></th><th><b>Problem type</b></th><th><b>Status</b></tr>

<%
String u=(String)session.getAttribute("id");

PreparedStatement ps=con.prepareStatement("select * from r_complaint where er_no=?");
ps.setString(1,u);
...
if(r.next()){
	...
	String er=r.getString(2);
	String nm=r.getString(3);
	String rd=r.getString(4);
	String p=r.getString(5);
	String pt=r.getString(6);
	String s=r.getString(7);
	%>
	<tr><td><%=cid%></td><td><%=er %></td><td><%=nm %></td><td><%=rd %></td><td><%=p %></td><td><%=pt %></td><td><%=s %></td></tr>
<%
